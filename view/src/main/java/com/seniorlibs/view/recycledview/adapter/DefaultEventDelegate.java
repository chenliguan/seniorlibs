...
public class DefaultEventDelegate implements InterEventDelegate {
    ...
    private void onMoreViewShowed() {
        LogUtils.e("TAG", "onMoreViewShowed");
    ...
    public class EventFooter implements InterItemView {
        ...
        void showError(){
            LogUtils.e("TAG", "footer showError");
            skipError = true;
            flag = SHOW_ERROR;
        ...
        void showMore(){
            LogUtils.e("TAG", "footer showMore");
            flag = SHOW_MORE;
            //noinspection deprecation
            if (adapter.getItemCount()>0){
                adapter.notifyItemChanged(adapter.getItemCount()-1);
        ...
        void showNoMore(){
            LogUtils.e("TAG", "footer showNoMore");
            skipNoMore = true;
            flag = SHOW_NO_MORE;
            //noinspection deprecation
            if (adapter.getItemCount()>0){
