...
import com.seniorlibs.baselib.utils.RecyclerUtils;
import com.seniorlibs.view.recycledview.GridSpanSizeLookup;
import com.seniorlibs.view.recycledview.adapter.BaseViewHolder;
import com.seniorlibs.view.recycledview.adapter.DefaultEventDelegate;
import com.seniorlibs.view.recycledview.inter.InterEventDelegate;
import com.seniorlibs.view.recycledview.inter.InterItemView;
import com.seniorlibs.view.recycledview.inter.OnErrorListener;
import com.seniorlibs.view.recycledview.inter.OnItemChildClickListener;
import com.seniorlibs.view.recycledview.inter.OnItemClickListener;
import com.seniorlibs.view.recycledview.inter.OnItemLongClickListener;
import com.seniorlibs.view.recycledview.inter.OnLoadMoreListener;
import com.seniorlibs.view.recycledview.inter.OnMoreListener;
import com.seniorlibs.view.recycledview.inter.OnNoMoreListener;
import com.seniorlibs.view.recycledview.observer.FixDataObserver;
...
public abstract class RecyclerArrayAdapter<T> extends RecyclerView.Adapter<BaseViewHolder> {
                ...
                gridManager.setSpanSizeLookup(new GridLayoutManager.SpanSizeLookup() {
                    ...
                    public int getSpanSize(int position) {
                        ...
                        if (itemViewType >= DefaultEventDelegate.EventFooter.HIDE &&
                            ...
                            LogUtils.e("TAG", "onAttachedToRecyclerView----这个是header和footer");
                            return gridManager.getSpanCount();
                        } else {
                            LogUtils.e("TAG", "onAttachedToRecyclerView----");
                            return 1;
                        }
                    }
                });
    ...
    public void add(T object) {
        ...
        LogUtils.e("TAG", "add notifyItemInserted " + (headers.size() + getCount()));
    }
    ...
    public void addAll(Collection<? extends T> collection) {
        ...
        LogUtils.e("TAG", "addAll notifyItemRangeInserted " + (headers.size() + getCount() - dataCount) + "," + (dataCount));
    ...
    public void insert(T object, int index) {
        ...
        LogUtils.e("TAG", "insert notifyItemRangeInserted " + (headers.size() + index));
    }
    ...
    public void insertAll(T[] object, int index) {
        ...
        LogUtils.e("TAG", "insertAll notifyItemRangeInserted " + ((headers.size() + index) + "," + (dataCount)));
    }
    ...
    public void update(T object, int pos) {
        ...
        LogUtils.e("TAG", "insertAll notifyItemChanged " + pos);
    }
    ...
    public void remove(T object) {
        ...
        synchronized (mLock) {
            if (mObjects.remove(object)) {
                ...
                LogUtils.e("TAG", "remove notifyItemRemoved " + (headers.size() + position));
            }
        }
    }
    ...
    public void setTop(int position) {
        ...
        LogUtils.e("TAG", "remove notifyItemRemoved " + (headers.size() + 1));
    }
    ...
    public void clear() {
        ...
        LogUtils.e("TAG", "clear notifyItemRangeRemoved " + (headers.size()) + "," + (count));
    }
