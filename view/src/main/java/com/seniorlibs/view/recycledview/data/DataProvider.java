package com.seniorlibs.view.recycledview.data;

import android.content.res.TypedArray;

import com.seniorlibs.view.R;
import com.seniorlibs.view.ViewApplication;
...
public class DataProvider {
    ...
    private static ArrayList<Integer> getData(){
        ...
        TypedArray bannerImage = ViewApplication.getContext().getResources().obtainTypedArray(R.array.image_girls);
        for (int i = 0; i < 30 ; i++) {
    ...
    private static ArrayList<Integer> getData2(){
        ArrayList<Integer> data = new ArrayList<>();
        TypedArray bannerImage = ViewApplication.getContext().getResources().obtainTypedArray(R.array.data_narrow_Image);
        for (int i = 0; i < 30 ; i++) {
            int image = bannerImage.getResourceId(i, R.drawable.girl2);
            data.add(image);
        }
