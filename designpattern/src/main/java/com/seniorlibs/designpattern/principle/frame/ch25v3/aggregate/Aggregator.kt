package com.seniorlibs.designpattern.principle.frame.ch25v3.aggregate
...
class Aggregator {
     ...
     */
    fun aggregate(
        requestInfos: Map<String, List<RequestInfo>>,
        durationInMillis: Long
    ): Map<String, RequestStat> {
        val requestStats  = mutableMapOf<String, RequestStat>()
